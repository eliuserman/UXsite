...
export const projects: Project[] = [
  ...
  {
    id: "klil-configurator",
    title: "Create your window",
    category: "Company: Bimmatch",
    description: "Klil Industries — a leading Israeli manufacturer, wanted to reach out to their website visitors and customers with a new experience to self-create a desirable product.",
    thumbnail: "/assets/klil_sc.png",
    role: "Product Owner and UX",
    duration: "4 months",
    team: "2 designers, 3 developers",
    tags: ["ConTech", "Research", "Web 3D", "three.js interactivity", "UX/UI Design"],
    challenge: "Klil's customers had no way to visualize or configure products online before purchasing — a major friction point in a highly customizable product catalog.",
    solution: "Designed and built an online 3D configurator enabling visitors to configure windows and doors in real time based on mathematical values and variables, preceded by deep technological and usability research.",
    results: [
      "Real-time 3D product configuration live on Klil's website",
      "Reduced pre-sales friction for prospective customers",
      "First configurator of its kind in the Israeli window manufacturing market",
    ],
    images: ["/assets/klil_sc.png"],
    content: {
      overview: "Klil Industries is one of Israel's leading aluminum window and door manufacturers. This project aimed to bridge the gap between their extensive product catalog and their customers' ability to visualize and configure a product before purchase.",
      research: "The project began with deep technological research into 3D rendering options for web (three.js, WebGL) and usability research into configurator patterns across industries. Key insight: simplicity of the configuration UI is as important as the 3D fidelity.",
      design: "Designed a mobile-first configurator UI allowing users to select product type, configuration, color, size, and mounting options — each reflected in real time in a 3D viewport. The design system was kept minimal to keep focus on the product.",
      outcome: "The configurator launched on Klil's website and became the primary product exploration tool for new visitors. The 3D interaction significantly increased engagement and reduced the sales cycle for standard configurations.",
    },
  },
  {
  ...
  {
    id: "vodafone-romania",
    title: "Vodafone Romania Retail App",
    category: "Company: Amdocs",
    description: "A story of assumption, failure, recovery, and a hard-won lesson about early business validation over technical shortcuts.",
    thumbnail: "/assets/vfro_app1.png",
    role: "UX Lead",
    duration: "6 months",
    team: "2 designers, 1 PM",
    tags: ["Telecom", "Retail App", "UX/UI Design", "Amdocs OOB", "Stakeholder Management"],
    challenge: "The project was initiated with MTEL as a reference, assuming technical backend similarity would translate to UI compatibility. This assumption was never validated with the Vodafone Romania business team.",
    solution: "After the initial design was rejected, we reset entirely — spending a week in Romania understanding the real business requirements, then rebuilding from Amdocs' OOB product as the correct foundation.",
    results: [
      "Client satisfaction reached highest management levels",
      "Increased Vodafone Romania's confidence in Amdocs as digital partner",
      "Delivered detailed design in 3 weeks after recovery",
    ],
    images: ["/assets/vfro_app1.png", "/assets/vfro_app2.png", "/assets/vfro_app3.png"],
    content: {
      overview: "A Vodafone Romania retail app project that started with the wrong assumption — that copying MTEL's UI would work — and recovered through proper business discovery and OOB-first design.",
      research: "A week of learning sessions with the Vodafone Romania business team revealed fundamentally different requirements from MTEL. Different products, different flows, different commercial model.",
      design: "Rebuilt from Amdocs OOB, customising to VFRO's brand and business specifics. High-fidelity mockups covering the full retail journey from plan selection to order confirmation.",
      outcome: "Delivered to strong approval from the highest management levels. The project became a reference for how Amdocs should approach telecom retail UX engagements going forward.",
    },
  },
];
