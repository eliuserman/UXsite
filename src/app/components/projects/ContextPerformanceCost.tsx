          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                During the development phase—and even more so once the first users (Mekorot's pilot testing team) began engaging with the system—we identified two major challenges associated with working with a large dataset (500+ documents), which we defined as key KPIs:
              </p>
        ...
        >
          ...
          <div className="space-y-4">
            {[
              ...
              { positive: true, label: null, text: "Keeping the engineer in its own context and interest" },
              ...
              >
                <div className={`flex-shrink-0 w-10 h-10 rounded-xl flex items-center justify-center ${item.positive ? "bg-blue-50" : "bg-gray-100"}`}>
                  {item.positive ? (
